...
namespace Hooks
{
	public class AssemblyStore
	{
		...
		private Dictionary<LIB_TYPE, AssemblyDefinition> _assemblies;
		...
		private static AssemblyStore _thisObject;
	...
	public static class AssemblyHelper
	{
		...
		public static void LoadAssembly(string filePath, out AssemblyDefinition assembly,
		...
		public static bool HasPatchMark(this AssemblyDefinition assembly)
		{
			...
			{
				fullTokenName = String.Format("{0}.{1}", AssemblyStore.TokenNamespace,
											  AssemblyStore.TokenIsPatched);
			}
		...
		public static void Save(this AssemblyStore.LIB_TYPE lib)
		{
			...
			(assDefinition.MainModule.AssemblyResolver as BaseAssemblyResolver).AddSearchDirectory(
				AssemblyStore.DataPath);
