    ...
    class PlayMakerFSM
    {
        ...
        private object ProxyCall(object thisObj, object[] args)
        {
            ...
            try
            {
                ...
                var method = TypeReflectionUtils.GetMethod("GetGlobalType", BindingFlags.Static | BindingFlags.Public);
                // Invoke it.
            ...
            } catch(TargetInvocationException e)
            {
                ...
                var msg = string.Format("Error in `HutongGames.PlayMaker.ReflectionUtils::GetGlobalType` for param {0}", args[0]);
